...
| **AWS CLI (tarball)**                  | ~27               | Fastest for single large file              | Needs pre-tarring and untarring step | When you can bundle files as tar               |
...
| **FUSE (cp tarball)**                  | ~15               | Fastest for large file, transparent access | Needs FUSE setup                     | For large files, or when tarball is available  |
...
- **Download methods**: Tar files significantly outperform recursive downloads for small file collections (3x faster)
