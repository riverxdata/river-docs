<h1>
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="images/nf-core-rnaseq_logo_dark.png"/>
    <img alt="nf-core/rnaseq" src="images/nf-core-rnaseq_logo_light.png"/>
  </picture>
</h1>
...
![nf-core/rnaseq metro map](images/nf-core-rnaseq_metro_map_grey_animated.svg)

> In case the image above is not loading, please have a look at the [static version](images/nf-core-rnaseq_metro_map_grey.png).
