...
As a contributor, you typically only need to select and execute tools, as these options are generally defined by the **Developer** role. For detailed information on tool implementation and configuration, please refer to the [**Developer**](/docs/3.platform/1.Developer.md) documentation.
