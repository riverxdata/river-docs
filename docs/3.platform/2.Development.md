...
Use the provided `Makefile` to automate environment setup and service management. It is used [**pixi**](pixi.sh/latest/) for a few setup while backend with the `pypy3.11` is configured.
